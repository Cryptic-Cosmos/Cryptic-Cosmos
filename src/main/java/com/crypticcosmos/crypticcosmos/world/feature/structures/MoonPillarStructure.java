package com.crypticcosmos.crypticcosmos.world.feature.structures;
...
public class MoonPillarStructure extends Structure<NoFeatureConfig> {
    ...
    public String getStructureName() {
        return CrypticCosmos.MOD_ID + ":moon_pillar";
    }
    ...
    protected ChunkPos getStartPositionForPosition(ChunkGenerator<?> generator, Random rand, int x, int z, int offsetX, int offsetZ) {
        ...
        ((SharedSeedRandom) rand).setLargeFeatureSeedWithSalt(
                generator.getSeed(),
                validChunkX,
                validChunkZ,
    ...
    public static class Start extends StructureStart {
        ...
        public void init(ChunkGenerator<?> generator, @Nonnull TemplateManager templateManagerIn, int chunkX, int chunkZ, @Nonnull Biome biomeIn) {
            ...
            CrypticCosmos.LOGGER.debug("We can find a moon pillar at: " + pos);
        }
    }
}
