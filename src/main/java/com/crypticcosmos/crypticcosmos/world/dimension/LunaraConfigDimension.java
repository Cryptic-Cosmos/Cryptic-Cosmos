...
public class LunaraConfigDimension extends Dimension {
    public LunaraConfigDimension(World world, DimensionType type) {
    ...
    public ChunkGenerator<?> createChunkGenerator() {
        return new LunaraChunkGenerator(world, new LunaraBiomeProvider(new LunaraBiomeProviderSettings(world.getWorldInfo())), new LunaraGenSettings());
    }
