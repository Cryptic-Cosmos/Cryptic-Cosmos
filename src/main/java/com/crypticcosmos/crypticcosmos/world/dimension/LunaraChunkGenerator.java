...
public class LunaraChunkGenerator extends NoiseChunkGenerator<LunaraGenSettings> {
    ...
    public LunaraChunkGenerator(IWorld worldIn, BiomeProvider provider, LunaraGenSettings settingsIn) {
