...
public class LunaraGenerator {
    ...
    private final static double DEFAULT_MOON_DISPLACEMENT = 1.0;
    private final static double DEFAULT_MOON_FREQUENCY = 1.0;
    private final static int DEFAULT_LUNARA_SEED = 0;
    //private static final double SQRT_3 = 1.7320508075688772935;

    private int seed = DEFAULT_LUNARA_SEED;
    ...
    public double getValue(double x, double y, double z) {
        double frequency = DEFAULT_MOON_FREQUENCY;
        x *= frequency;
        y *= frequency;
        z *= frequency;
        ...
        */
        ...
        return value + (DEFAULT_MOON_DISPLACEMENT * ValueNoise3D(
