...
public class BiomeHandeler {
    ...
    public static final RegistryObject<Biome> MOON_BIOME = BIOMES.register("moon_biome", () -> new MoonBiome(new Biome.Builder().surfaceBuilder(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(BlockHandeler.))));
}
