...
public class ModBiomes {
    ...
    public static void registerBiomes()
    {
        ...
        registerMoonBiome(MOON_MOUNTAINS.get(), Type.MOUNTAIN, Type.DRY, Type.COLD, Type.DEAD);
        registerMoonBiome(MOON_FOREST.get(), Type.FOREST, Type.DRY, Type.COLD, Type.DEAD);
    }
