...
public class MoonTree extends Tree {
    public static final TreeFeatureConfig MOON_TREE_CONFIG2 = (
            ...
            .setSapling((IPlantable) BlockHandler.MOON_SAPLING.get()).build();

    public static final TreeFeatureConfig MOON_TREE_CONFIG = (
            new TreeFeatureConfig.Builder(
