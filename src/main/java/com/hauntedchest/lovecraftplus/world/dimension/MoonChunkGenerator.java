...
public class MoonChunkGenerator extends NoiseChunkGenerator<MoonGenSettings> {
    ...
    protected void fillNoiseColumn(@Nonnull double[] noiseColumn, int noiseX, int noiseZ) {
        ...
        int i = -10;
        int j = 3;
        this.calcNoiseColumn(noiseColumn,
                noiseX,
                noiseZ,
                d0,
                d1,
    ...
    protected @Nonnull
    double[] getBiomeNoiseColumn(int noiseX, int noiseZ) {
    ...
    private double getNoiseDepthAt(int noiseX, int noiseZ) {
        double d0 = this.depthNoise.getValue(noiseX * 200,
                10.0D,
                noiseZ * 200,
                1.0D,
                0.0D,
                true) * 65535.0D / 8000.0D;
    ...
    List<Biome.SpawnListEntry> getPossibleCreatures(
            @Nonnull EntityClassification creatureType, @Nonnull BlockPos pos) {
