...
public class MoonGenerator {
    ...
    final static double DEFAULT_MOON_DISPLACEMENT = 1.0;
    final static double DEFAULT_MOON_FREQUENCY = 1.0;
    final static int DEFAULT_MOON_SEED = 0;
    ...
    public MoonGenerator() {
        displacement = DEFAULT_MOON_DISPLACEMENT;
        enableDistance = false;
        frequency = DEFAULT_MOON_FREQUENCY;
        seed = DEFAULT_MOON_SEED;
    }
    ...
    public double getValue(double x, double y, double z) {
        ...
        if (enableDistance) {
            ...
            value = 0.0;
        return value + (displacement * ValueNoise3D((int) (Math.floor(xCandidate)),
