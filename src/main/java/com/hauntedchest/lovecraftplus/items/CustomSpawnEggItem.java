...
public class CustomSpawnEggItem extends SpawnEggItem {
    ...
    public CustomSpawnEggItem(final NonNullSupplier<? extends EntityType<?>> entityTypeSupplier,
                              int primaryColorIn,
    ...
    public static void initSpawnEggs() {
        final Map<EntityType<?>, SpawnEggItem> EGGS = Objects.requireNonNull(ObfuscationReflectionHelper.getPrivateValue(
